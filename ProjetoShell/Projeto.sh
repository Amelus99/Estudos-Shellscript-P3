...
yad --center \
	...
	--button="Iniciar Processo":'bash -c "yad --center --title="Iniciar" --width=300 --height=300 --tail --list --field="Qual o nome do Processo?""' \
	--button="Finalizar Processo":'bash -c "yad --center --title="Finalizar" --width=300 --height=300 --tail --list --field="Qual o PID do Processo?""'
)
